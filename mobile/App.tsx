    ...
    >
      ...
      <View className='flex-1 items-center justify-center gap-6' >
        ...
        <View className='space-y-2' >
          ...
          <Text className='text-center font-body text-base leading-relaxed text-gray-100' >Coloque momentos marcantes da sua jornada e compartilhe (se quiser) comm o mundo!</Text>
        </View>
        <TouchableOpacity activeOpacity={0.7} className='rounded-full bg-green-500 px-5 py-2' >
          <Text className='font-alt text-sm uppercase text-black' >Cadastrar Lembrabça</Text>
        </TouchableOpacity>
      </View>
